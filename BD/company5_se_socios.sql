...
-- Tiempo de generación: 06-02-2023 a las 19:46:23
...
--
-- Base de datos: `company5_se_socios`
--
...
(2, 15, 'liferli.png', 'inversionesferlisac@gmail.com', 'www.page.com', '922012611', 1);
...
(1, '20000000000', 'PEPITO SAC', 'Mza. o Lote. 17 Asc. Villa Universitaria (Grifo Repsol)', 150117, 'informes@grrepresentaciones.com', 1),
(12, '00000000001', 'AGENTE NACIONAL DSCG', 'LOS OLIVOS', 150117, NULL, 1),
(14, '00000000002', 'AGENTE EXPOTADOR DSCG', 'LOS OLIVOS', 150117, NULL, 1),
(15, '20607330647', 'INVERSIONES LIFERLI SAC', 'Mza. C Lote. 2 A.F. Villa de los Angeles Sect', 30709, NULL, 1);
...
CREATE TABLE `modulos` (
  ...
  `gmo_order` int NOT NULL DEFAULT '1',
...
INSERT INTO `modulos` (`gmo_id`, `gmo_titulo`, `gmo_descripcion`, `gmo_gmo_id`, `gmo_path`, `gmo_order`, `gmo_icon`, `gmo_status`) VALUES
(1, 'DASHBOARD', NULL, NULL, '/dashboard', 1, 'fa fa-dashboard', 1),
(2, 'ADMINISTRACION', NULL, NULL, '#', 1, 'fas fa-users-cog', 1),
(3, 'Usuarios', NULL, 2, '/usuarios', 1, 'fas fa-user-alt', 1),
(4, 'Roles', NULL, 2, '/roles', 1, 'fas fa-portrait', 1),
(5, 'Almacenes', NULL, 2, '/almacenes', 1, 'fas fa-building', 1),
(6, 'Modulos', NULL, 2, '/modulos', 1, 'fas fa-warehouse', 1),
(7, 'Empresas', NULL, 2, '/empresas', 1, 'fas fa-building', 1),
(8, 'BASES DE DATOS', NULL, NULL, '#', 1, 'fas fa-database', 1),
(9, 'Clientes', NULL, 8, '/Agentes/clientes', 1, 'fa fa-database', 1),
(10, 'Proveedores', NULL, 8, '/Agentes/proveedores', 1, 'fas fa-user-check', 1),
(11, 'Cuentas', NULL, 8, '/Cuentas', 1, 'fas fa-file-invoice-dollar', 1),
(12, 'Bienes', NULL, 8, '/bienes', 1, 'fas fa-clipboard-list', 1),
(13, 'LOGISTICO', NULL, NULL, '#', 1, 'fas fa-boxes', 1),
(14, 'Entradas', NULL, 13, '#', 1, 'fa fa-database', 1),
(15, 'Saldos Iniciales', NULL, 14, '/sbienes', 1, 'fas fa-warehouse', 1),
(16, 'Notas de Entrada', NULL, 14, '/entradas', 1, 'far fa-file-alt', 1),
(17, 'Salidas', NULL, 13, '#', 1, 'fas fa-user-check', 1),
(18, 'Ventas', NULL, 13, '/salidas', 1, 'far fa-file-alt', 1),
(19, 'Mermas', NULL, 17, '/mermas', 1, 'fas fa-pallet', 1),
(20, 'Transferencias', NULL, 17, '/transferencias', 1, 'fas fa-dolly-flatbed', 1),
(21, 'Saldos', NULL, 13, '/Bienes/sbienes', 1, 'fas fa-warehouse', 1),
(22, 'Ventas', NULL, 13, '/Gerencial/cventas', 1, 'fas fa-chart-line', 1),
(23, 'FINANCIERO', NULL, NULL, '#', 1, 'fas fa-landmark', 1),
(24, 'Cuentas', NULL, 23, '/cuentas', 1, 'fas fa-file-invoice-dollar', 1),
(25, 'Saldo Inicial', NULL, 23, '/Cajas/scuentas', 1, 'fas fa-wallet', 1),
(26, 'Ingresos', NULL, 23, '/Cajas/ingresos', 1, 'fas fa-hand-holding-usd', 1),
(27, 'Egresos', NULL, 23, '/Cajas/egresos', 1, 'fas fa-receipt', 1),
(28, 'Gastos', NULL, 23, '/Cajas/gastos', 1, 'fas fa-stamp', 1),
(29, 'Sub Total Gastos', NULL, 23, '/Cajas/subgastos', 1, 'fas fa-stamp', 1),
(30, 'Caja Internos', NULL, 23, '/Cajas/cinternos', 1, 'fas fa-coins', 1),
(31, 'Ingresos Otros', NULL, 23, '/Cajas/iadicionales', 1, 'fas fa-donate', 1),
(32, 'LIQUIDEZ', NULL, NULL, '#', 1, 'fas fa-handshake', 1),
(33, 'Notas de Credito', NULL, 32, '/Liquidez/castigos', 1, 'fas fa-file-invoice', 1),
(34, 'Notas de Debito', NULL, 32, '/Liquidez/premios', 1, 'fas fa-file-invoice', 1),
(35, 'Estado Actual', NULL, 32, '/liquidez?t=ncuadre', 1, 'fas fa-id-card-alt', 1),
(36, 'Historial Cuadre', NULL, 32, '/liquidez?t=cuadre', 1, 'fas fa-id-card-alt', 1),
(37, 'GERENCIAL', NULL, NULL, '#', 1, 'fas fa-chart-pie', 1),
(38, 'Resumen Capital', NULL, 37, '/gerencial', 1, 'fas fa-file-alt', 1),
(39, 'Resumen de Materiales', NULL, 37, '/Bienes/Smateriales', 1, 'fas fa-file-alt', 1),
(40, 'Margen en Ventas', NULL, 37, '/Gerencial/cventas', 1, 'fas fa-file-alt', 1),
(41, 'Detracciones', NULL, 37, '/Gerencial/detracciones', 1, 'fas fa-file-alt', 1),
(42, 'Exportaciones', NULL, 37, '/Gerencial/exportaciones', 1, 'fas fa-file-alt', 1),
(43, 'Estado de Resultados', NULL, 37, '/Gerencial/resultados', 1, 'fas fa-file-alt', 1),
(44, 'RR.HH.', NULL, NULL, '#', 1, 'far fa-address-book', 1),
(45, 'Personales', NULL, 44, '/colaboradores', 1, 'fas fa-address-book', 1),
(46, 'Asistencias', NULL, 44, '/asistencias', 1, 'fas fa-check-circle', 1),
(47, 'Planillas', NULL, 44, '/planillas', 1, 'fas fa-calendar-check', 1),
(48, 'Pagos Planillas', NULL, 44, '/ppagos', 1, 'fas fa-money-bill-wave', 1),
(49, 'OTROS', NULL, NULL, '#', 1, 'fas fa-folder-open', 1),
(50, 'utilitarios', NULL, 49, '/utilitarios', 1, 'fas fa-lightbulb', 1),
(51, 'SALIR', NULL, NULL, '/logout', 1, 'fa fa-sign-out', 1),
(52, 'Volumen de Ventas', NULL, 13, '/Gerencial/volumen', 1, 'fas fa-chart-line', 1),
(53, 'Orden de Compra', NULL, 13, '/ordencompra', 1, 'fas fa-file-invoice', 1);
...
(295, 2, '2022-12-01', '3.8490', '3.8540'),
(296, 2, '2022-11-30', '3.8400', '3.8470'),
(297, 2, '2022-12-02', '3.8270', '3.8360'),
(298, 2, '2022-11-22', '3.8310', '3.8380'),
(299, 2, '2022-11-17', '3.8370', '3.8420'),
(300, 2, '2022-11-18', '3.8400', '3.8450'),
(301, 2, '2022-11-23', '3.8420', '3.8460'),
(302, 2, '2022-11-25', '3.8390', '3.8500'),
(303, 2, '2022-11-29', '3.8510', '3.8610'),
(304, 2, '2022-12-03', '3.8260', '3.8350'),
(305, 2, '2022-12-05', '3.8260', '3.8350'),
(306, 2, '2022-12-06', '3.8440', '3.8480'),
(307, 2, '2022-12-07', '3.8430', '3.8510'),
(308, 2, '2022-12-08', '3.8300', '3.8510'),
(309, 2, '2022-12-12', '3.8300', '3.8510'),
(310, 2, '2022-12-13', '3.8280', '3.8400'),
(311, 2, '2022-12-14', '3.8260', '3.8350'),
(312, 2, '2022-12-15', '3.8310', '3.8410'),
(313, 2, '2022-12-16', '3.8410', '3.8490'),
(314, 2, '2022-12-17', '3.8420', '3.8530'),
(315, 2, '2022-12-19', '3.8420', '3.8530'),
(316, 2, '2022-12-18', '3.8420', '3.8530'),
(317, 2, '2022-12-20', '3.8280', '3.8420'),
(318, 2, '2022-10-04', '3.9630', '3.9690'),
(319, 2, '2022-12-21', '3.8260', '3.8390'),
(320, 2, '2022-12-22', '3.8150', '3.8250'),
(321, 2, '2022-12-23', '3.8070', '3.8190'),
(322, 2, '2022-12-24', '3.8090', '3.8270'),
(323, 2, '2022-12-26', '3.8090', '3.8270'),
(324, 2, '2022-10-10', '3.9720', '3.9800'),
(325, 2, '2022-12-27', '3.8140', '3.8230'),
(326, 2, '2022-12-28', '3.8150', '3.8220'),
(327, 2, '2022-12-29', '3.8070', '3.8170'),
(328, 2, '2022-12-30', '3.8090', '3.8180'),
(329, 2, '2022-12-31', '3.8080', '3.8200'),
(330, 2, '2023-01-02', '3.8080', '3.8200'),
(331, 2, '2023-01-01', '3.8080', '3.8200'),
(332, 2, '2023-01-03', '3.8080', '3.8200'),
(333, 2, '2023-01-04', '3.8120', '3.8230'),
(334, 2, '2023-01-05', '3.8220', '3.8270'),
(335, 2, '2023-01-06', '3.8240', '3.8300'),
(336, 2, '2023-01-07', '3.8000', '3.8060'),
(337, 2, '2023-01-09', '3.8000', '3.8060'),
(338, 2, '2023-01-10', '3.7920', '3.8030'),
(339, 2, '2023-01-11', '3.8020', '3.8060'),
(340, 2, '2023-01-12', '3.7820', '3.7830'),
(341, 2, '2023-01-13', '3.7790', '3.7840'),
(342, 2, '2023-01-17', '3.8150', '3.8220'),
(343, 2, '2023-02-06', '3.8430', '3.8470'),
(344, 2, '2023-02-06', '3.8430', '3.8470'),
(345, 2, '2023-02-06', '3.8430', '3.8470'),
(346, 2, '2023-02-06', '3.8430', '3.8470');
...
--
ALTER TABLE `accesos`
  MODIFY `gac_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `areas`
--
ALTER TABLE `areas`
  MODIFY `gar_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `clientes`
--
ALTER TABLE `clientes`
  MODIFY `gcl_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `empresas`
  MODIFY `gem_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `modulos`
--
ALTER TABLE `modulos`
  MODIFY `gmo_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- AUTO_INCREMENT de la tabla `personas`
--
ALTER TABLE `personas`
  MODIFY `gpe_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;
...
--
ALTER TABLE `tcambios`
  MODIFY `gtc_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=347;

--
-- AUTO_INCREMENT de la tabla `tpermisos`
--
ALTER TABLE `tpermisos`
  MODIFY `gtp_id` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=260;
