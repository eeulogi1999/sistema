      ...
      <div class="modal-body">
        ...
        <form id="form_caj" name="form_caj" class="form-horizontal">
            ...
            <div class="row mb-3">
              ...
              <div class="form-group col mb-0">
                <label for="caj_tce_id">Tipo de Cambio<span class="required">*</span></label>
                <div class="row">
                  <div class="col-md-3 pr-0 pt-1 text-center">
                    <label class="switch">
            ...
            <div class="form-group col mb-0">
                <label for="caj_cue_id">Cuenta O.</label>
                <select class="form-control" id="caj_cue_id" name="caj_cue_id"></select>
              </div>
              <div class="form-group col mb-0">
                <label for="caj_gt4_id">Moneda O.<span class="required">*</span></label>
            ...
            <div class="row mb-3">
              ...
              <div class="form-group col mb-0">
                <label for="caj_d_gt4_id">Moneda D.<span class="required">*</span></label>
                <select class="form-control" id="caj_d_gt4_id" name="caj_d_gt4_id"></select>
              </div>
              <div class="form-group col mb-0">
              ...
              <div class="form-group col mb-0">
                <label for="caj_montod">Monto<span class="required">*</span></label>
                <input type="text" class="form-control valid" id="caj_montod" name="caj_montod" required="">
              </div>
            </div>
        </form>
