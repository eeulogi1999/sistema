      ...
      <div class="app-title">
        <div>
            <h1><i class="fas fa-user-tag"></i> <?= $data['page_title'] ?>
                ...
                <button class="btn btn-primary" type="button" onclick="openmodal_ads();" ><i class="fas fa-plus-circle"></i> Nuevo</button>
              <?php } ?>
            </h1>
        </div>
            ...
            <div class="col-md-12">
              <div class="tile">
                <div class="tile-body">
                  ...
                  <table class="table table-hover table-bordered" id="ads_table">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th>CODIGO</th>
