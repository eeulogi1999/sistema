                ...
                <section id="sPedido" class="invoice">
                        ...
                        <div class="col-4 border rounded border-secondary align-items-center py-3">
                            <div>
                                ...
                                <h1 class="text-center">
                                    <?= $mov['mov_serie'].'-'.str_pad($mov['mov_numero'],8,0,STR_PAD_LEFT) ?></h1>
                                <h5 class="text-center text-danger">N° OPERACION:
                                    <strong><?= $mov['mov_tipo'].'-'.date( "m", strtotime($mov['mov_fechaE'])).str_pad($mov['mov_t12num'],6,0,STR_PAD_LEFT) ?></strong>
                                </h5>
                            </div>
                        </div>
                    </div>
                    <div class="row invoice-info">
                        <div class="col-8 ">
                            ...
                            <div
                                class="border rounded border-secondary h-115 justify-content-center align-items-center p-3">
                                <strong><?= !isset($mov['mov_age_id']['age_gem_id'])?'Razón Social ':'Nombre:' ?></strong>
                                <?= $mov['mov_age_id']['age_nombre'] ?><br>
                                <strong><?= !isset($mov['mov_age_id']['age_gem_id'])?'RUC ':'Identificacion:' ?>
                                </strong><?= $mov['mov_age_id']['age_ide'] ?><br>
                                <strong> Direccion:</strong>
                                <?= !isset($mov['mov_age_id'])?'':$mov['mov_age_id']['age_direccion'] ?><br>
                                ...
                                <div
                                    ...
                                    <?php }?>
                                    <strong>Registrado
                                        Por:</strong><?= (!empty($mov['mov_gus_id'])) ? $mov['mov_gus_id']['gus_gpe_id']['gpe_nombre'] : ''?>
                                </div>
                            </div>
                            <div
                                class="col-4 border rounded border-secondary h-115 justify-content-center align-items-center">
                                <div class=" p-3" style="height: 118px;">
                                    ...
                                    <b>Cuenta:</b>
                                    <?= (!empty($mov['mov_cue_id']))?$mov['mov_cue_id']['cue_nombre']:''; ?>
                                </div>
                                ...
                                if(count($detalles) > 0){
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-left"><?= $producto['mde_t6m_id']['t6m_descripcion']; ?>
                                            </td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="<?= ($mov['mov_t12_id']['t12_id']==18)?4:3?>">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><?= formatMoney($mov['mov_igv_id']['mov_igv']) ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="<?= ($mov['mov_t12_id']['t12_id']==18)?4:3?>"></td>
                                            <td colspan="2" class="text-right">DESCUENTOS:</td>
                                            <td class="text-right"><?= formatMoney($mov['mov_igv_id']['mov_des']) ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="<?= ($mov['mov_t12_id']['t12_id']==18)?4:3?>" ></td>
                                        ...
                                        <tr>
                                            <td colspan="<?= ($mov['mov_t12_id']['t12_id']==18)?6:5?>"
                                                class="text-right">Neto a Pago:</td>
                                            <td class="text-right"><?= formatMoney($mov['mov_igv_id']['mov_neto']) ?>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tfoot>
                        ...
                        <div class="row">
                            ...
                            <h4 class="text-center">SECCION DE GASTOS</h4>
