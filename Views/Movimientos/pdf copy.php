...
<body>
    ...
    <table class="tbl-cliente">
        <tbody>
            <tr>
                ...
                <td class="wd55 color_general"><strong><?= !empty($mov['mov_age_id'])?$mov['mov_age_id']['age_nombre']:''?></strong></td>
                <td class="color_general">MARCA:</td>
                <td class="wd20 color_general"><strong><?= $mov['mov_age_id']['age_marca'] ?></strong></td>
            </tr>
        </tbody>
    </table>
    <br>
    <table class="tbl-detalle">
        <thead>
            <tr>
                <th class="wd20 text-center">CANT</th>
                <th class="wd20">DESCRIPCIÓN</th>
                <th class="wd20 text-center">CALIDAD</th>
                <th class="wd20 text-right">P.U.</th>
