            ...
            <tr>
                <td>
                    <table class="table table-borderless table-sm fz-12">
                        <tr>
                            <td>AGENTE</td>
                            <td><?=($data['age']['age_gem_id']) ? $data['age']['age_gem_id']['gem_razonsocial'] : $data['age']['age_gpe_id']['gpe_nombre'].', '.$data['age']['age_gpe_id']['gpe_apellidos'] ;?></td>
                        </tr>
                        <tr>
                            <td>DIRECCIÓN</td>
                            <td><?=($data['age']['age_gem_id']) ? $data['age']['age_gem_id']['gem_direccion'] : $data['age']['age_gpe_id']['gpe_direccion'] ;?></td>
                        </tr>
                        <tr>
                            <td>FECHA</td>
                            <td><?= date("Y-m-d")?></td>
