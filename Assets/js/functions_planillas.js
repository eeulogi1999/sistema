...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (document.querySelector("#pla_table")) {
    pla_table = $("#pla_table").autoTable({
      ...
      columns: [
        {
          data: "pla_col_id.col_gpe_id.gpe_nombre",
          header: { t: "NOMBRE", c: "text" },
          tipo: "string",
        },
        {
          data: "pla_col_id.col_gpe_id.gpe_apellidos",
          header: { t: "APELLIDOS", c: "text" },
          tipo: "string",
        },
        ...
        { data: "pla_ext", header: { t: "OTROS" }, tipo: "money" },
        { data: "pla_sueldo", header: { t: "SUELDO" }, tipo: "money" },
        { data: "pla_adelantos", header: { t: "ADELANTOS" }, tipo: "money" },
        {
          data: "pla_tpagar",
          header: { t: "TOTAL PAGAR" },
          style: { condition: { minzero: "text-danger" } },
          tipo: "money",
        },
  ...
  if (document.querySelector("#week")) {
    ...
    $("#week").change(function (e) {
      ...
      fetch(base_url + "/Asistencias/changeWeek", {
        method: "POST",
        body: formData,
      })
        .then((r) => r.json())
